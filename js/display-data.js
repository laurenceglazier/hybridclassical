...
function handleMotion(event) {
  ...
  motionProperties += "alpha: " + event.rotationRate.alpha.toFixed(1) + "<br>";
  motionProperties += "beta: " + event.rotationRate.beta.toFixed(1) + "<br>";
  motionProperties += "gamma: " + event.rotationRate.gamma.toFixed(1) + "<br>";
  motionProperties += "timeStamp (ms): " + event.timeStamp.toFixed(1) + "<br>";
